...
matrix_of_features_train=lda.fit_transform(matrix_of_features_train,dependent_variable_vector_train)
matrix_of_features_test=lda.transform(matrix_of_features_test)
